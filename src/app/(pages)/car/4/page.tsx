...
export default function IndividualCar() {
  const images = [
    { src: "/images/camiones/4_camion/1.webp", alt: "Autos" },
    { src: "/images/camiones/4_camion/2.webp", alt: "Autos" },
    { src: "/images/camiones/4_camion/3.webp", alt: "Autos" },
    { src: "/images/camiones/4_camion/4.webp", alt: "Autos" },
    { src: "/images/camiones/4_camion/5.webp", alt: "Autos" },
    { src: "/images/camiones/4_camion/6.webp", alt: "Autos" },
  ];
